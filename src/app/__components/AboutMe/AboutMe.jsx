...
export default function AboutMe() {
  ...
  const text = "My Name is Mohamed Hanafi";
  const text2 = "I'M FRONT END DEVELOPER.";
  return (
    <div
      className="HomePage flex lg:justify-between md:justify-center md:flex-col lg:flex-row sm:justify-center sm:items-center sm:flex-col 
    md:items-center
